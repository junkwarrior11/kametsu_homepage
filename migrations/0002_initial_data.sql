...
-- 1. ヘッダー (4フィールド)
INSERT OR IGNORE INTO site_settings (setting_key, setting_value, setting_group, description) VALUES
...
-- サンプルブログ記事
INSERT OR IGNORE INTO blog_posts (id, title, content, category, status, publish_date) VALUES
('blog001', '令和6年度 運動会のご案内', '10月15日（日）に運動会を開催いたします。保護者の皆様のご来場をお待ちしております。', '行事', '公開', '2024-09-20 09:00:00'),
('blog002', '夏休み明けの学校生活', '長い夏休みが終わり、子どもたちは元気に登校しています。2学期も充実した学校生活を送れるよう、職員一同サポートしてまいります。', 'お知らせ', '公開', '2024-09-01 10:00:00'),
('blog003', '地域清掃活動を実施しました', '6年生が地域の清掃活動に参加しました。地域の方々と協力して、学校周辺をきれいにすることができました。', '活動報告', '公開', '2024-08-25 14:00:00'),
('blog004', '水泳学習が始まりました', '今週から水泳学習が始まりました。安全に配慮しながら、楽しく水に親しむ活動を行っています。', '活動報告', '公開', '2024-07-10 11:00:00');

-- サンプル学校だより
INSERT OR IGNORE INTO newsletters (id, title, issue_number, issue_date, description) VALUES
('news001', '亀津小だより 9月号', 9, '2024-09-01', '2学期がスタートしました。運動会に向けての取り組みをお知らせします。'),
('news002', '亀津小だより 8月号', 8, '2024-08-01', '夏休み中の学校の様子と、2学期に向けた準備についてお知らせします。'),
('news003', '亀津小だより 7月号', 7, '2024-07-01', '1学期の振り返りと夏休みの過ごし方についてお知らせします。');

-- サンプル行事予定
INSERT OR IGNORE INTO events (id, title, event_date, category, description, location, target_grade) VALUES
('event001', '始業式', '2024-09-02', '秋の行事', '2学期の始業式を行います。', '体育館', '全学年'),
('event002', '運動会', '2024-10-15', '秋の行事', '秋の大運動会を開催します。雨天時は翌日に順延します。', '校庭', '全学年'),
('event003', '修学旅行', '2024-11-10', '秋の行事', '6年生が鹿児島市内を巡る修学旅行に出発します。', '鹿児島市内', '6年生'),
('event004', '学習発表会', '2024-12-05', '冬の行事', '各学年の学習成果を発表します。', '体育館', '全学年'),
('event005', '終業式', '2024-12-25', '冬の行事', '2学期の終業式を行います。', '体育館', '全学年'),
('event006', 'マラソン大会', '2025-02-15', '冬の行事', '校内マラソン大会を開催します。', '学校周辺', '全学年');

-- アクセス統計の初期化
INSERT OR IGNORE INTO access_stats (stat_type, year_month, page_name, count) VALUES
('total', 'total', 'all', 0),
('monthly', strftime('%Y-%m', 'now'), 'all', 0);
